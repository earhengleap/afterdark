...
class Languages:
    ...
    TRANSLATIONS = {
        'en': {
            ...
            'welcome_description': 'I help you download videos and images from X (Twitter) quickly and easily!',
        ...
        'km': {
            ...
            'welcome_description': 'ខ្ញុំជួយអ្នកទាញយកវីដេអូ និងរូបភាពពី X (Twitter) យ៉ាងរហ័សនិងងាយស្រួលបំផុត!',
            'quick_actions': 'សកម្មភាពរហ័ស៖',
            'download_video': 'ទាញយកវីដេអូ',
            'download_images': 'ទាញយករូបភាព',
            'bulk_upload': 'ផ្ទុកឡើងច្រើន',
            'statistics': 'ស្ថិតិប្រើប្រាស់',
            'help': 'ជំនួយ',
            'about': 'អំពីប៊ូត',
            'settings': 'ការកំណត់',
            'main_menu': 'ម៉ឺនុយមេ',
            ...
            'send_url': 'សូមផ្ញើតំណ URL វីដេអូ ឬរូបភាព X/Twitter ឥឡូវនេះ។',
            'single_url': 'URL តែមួយ៖',
            'multiple_urls': 'URL ច្រើន (ជ្រើសរើសទម្រង់ណាមួយ)៖',
            ...
            'failed': 'បរាជ័យ',
            'time': 'ពេលវេលា',
            'videos_saved': 'ឯកសារត្រូវបានរក្សាទុកនិងផ្ញើទៅអ្នក។',
